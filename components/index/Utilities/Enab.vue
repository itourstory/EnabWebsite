<template>
  <div>
    ...
    >
      ...
      <path
        style="fill: #67449e"
        d="M458.328,470.367c-32.552-7.577-52.798-40.109-45.22-72.661
      ...
      <path
        style="fill: #93603e"
        d="M172.053,169.022c1.505,0.35,2.979,0.765,4.429,1.221c0.593-2.533,1.355-4.98,2.241-7.355
      ...
      <path
        style="fill: #7f573c"
        d="M148.749,133.05C112.325,109.657,62.328,87.631,9.034,93.805c-3.133,0.363-6.001-1.141-7.631-3.545
      ...
      <path
        style="fill: #3bbc56"
        d="M83.067,284.142c7.706-9.393,18.096-16.257,29.723-19.645c1.882,2.214-20.481-19.894-12.856-52.653
      ...
      <path
        style="fill: #30aa44"
        d="M58.169,280.28c-4.177-1.063-6.291-5.711-4.415-9.592c9.053-18.73,20.221-32.922,32.267-43.655
      ...
      <path
        style="fill: #3bbc56"
        d="M248.579,125.439c3.422,0.796,6.7,1.881,9.829,3.204c7.702-11.945,19.4-20.697,32.789-24.842
      ...
      <path
        style="fill: #30aa44"
        d="M202.547,52.579c-2.977-2.846-5.709-5.219-7.97-7.069c-3.336-2.731-8.325-1.676-10.336,2.138
      ...
      <path
        style="fill: #67449e"
        d="M314.387,218.949c-32.552-7.577-52.798-40.109-45.22-72.661
                c5.679-24.395,25.372-41.877,48.586-45.918c-31.354-5.403-61.858,14.532-69.164,45.918c-7.577,32.552,12.668,65.083,45.22,72.661
      ...
      <path
        style="fill: #67449e"
        d="M247.873,415.467c-32.552-7.577-52.798-40.109-45.22-72.66c5.679-24.395,25.372-41.877,48.586-45.918
      ...
      <path
        style="fill: #67449e"
        d="M134.202,380.664c-32.552-7.577-52.798-40.109-45.22-72.661
                c5.679-24.395,25.372-41.877,48.586-45.918c-31.354-5.403-61.858,14.532-69.164,45.918c-7.577,32.552,12.668,65.083,45.22,72.661
      ...
      <path
        style="fill: #7b54ba"
        d="M326.466,298.931c-32.309-7.521-52.403-39.809-44.883-72.118c5.63-24.185,25.139-41.523,48.145-45.56
      ...
      <path
        style="fill: #7b54ba"
        d="M419.185,382.553c-32.309-7.521-52.403-39.809-44.883-72.118c5.63-24.185,25.139-41.523,48.145-45.56
                c-31.155-5.424-61.49,14.374-68.75,45.56c-7.521,32.309,12.574,64.597,44.883,72.118c8.124,1.891,16.246,2.033,23.974,0.677
      ...
      <path
        style="fill: #7b54ba"
        d="M360.988,462.024c-32.309-7.521-52.403-39.809-44.883-72.118c5.63-24.185,25.139-41.523,48.145-45.56
                c-31.155-5.424-61.49,14.374-68.75,45.56c-7.521,32.309,12.574,64.597,44.883,72.118c8.124,1.891,16.246,2.033,23.974,0.677
      ...
      <path
        style="fill: #7b54ba"
        d="M163.354,283.961c-32.309-7.521-52.403-39.809-44.883-72.118c5.63-24.185,25.139-41.523,48.145-45.56
                c-31.155-5.424-61.49,14.374-68.75,45.56c-7.521,32.309,12.574,64.597,44.883,72.118c8.124,1.891,16.246,2.033,23.974,0.677
      ...
      <path
        style="fill: #987fc9"
        d="M235.714,343.092c-32.309-7.521-52.404-39.809-44.883-72.118c5.63-24.185,25.138-41.523,48.144-45.56
...
<style lang="scss" scoped>
    ...
    .supermarket:hover{
        fill: #5c3c94 !important;
        pointer-events: all;
        filter: drop-shadow(0px 0px 15px #9067d8);
    }
    .supermarket:after,.supermarket:hover{
        content: "dfjiejefhefeihfiefifhiewjhfij";
